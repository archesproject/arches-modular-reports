...
Arches Modular Reports is an Arches Application that provides an alternate and more modular way to present and configure reports for Arches versions 8.0+.
...
3. Next ensure arches, arches_modular_reports are included as dependencies in package.json
    ...
    "dependencies": {
        ...
        "arches-modular-reports": "archesproject/arches-modular-reports#stable/2.0.0"
    }
    ```
