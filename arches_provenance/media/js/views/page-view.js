            ...
            _.defaults(this.viewModel, {
                ...
                getHelp: function(template) {
                    ...
                    $.ajax({
                        ...
                        function setupToggle(el, toggleSelector, linkSelector, contentSelector) {
                            
                            const searchLink = $(el).find(linkSelector);
                            const toggleButton = $(el).find(toggleSelector);
                            const content = $(el).find(contentSelector);
                    
                            
                            let isExpanded = toggleButton.attr('aria-expanded') === 'true';
                            toggleButton.attr('aria-expanded', isExpanded ? 'false' : 'true');
                            content.slideToggle();
                        ...
                        $(el).find('.advanced-content-toggle').click(function() {
                        ...
                        $(el).find('.save-toggle').click(function() {
                            setupToggle(el, '.save-toggle', "[data-toggle='save-search_new']", '.save-content');
                        });
