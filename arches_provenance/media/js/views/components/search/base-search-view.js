        ...
        doQuery: function() {
            ...
            self.updateRequest = $.ajax({
                ...
                success: function(response) {
                    ...
                    $('.search-title').text('Results: '+ response.results.hits.hits.length +' of '+ (response.total_results ? response.total_results.toLocaleString('en-US') : '0'));
